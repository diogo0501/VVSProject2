...
public class TestAdress {
	...
	//get table if exists.If exists get its size, otherwise save it size as 0




	//get into insert new adress to customer

	//verify that we are, indeed, in that page

	//insert the example adress

	//verify that everything went well

	//go to find costumer by vat number

	//verify that we are in that specific page

	//check table and compare if info are correct and table was, in fact, increased by one (check last row)
